...
def quick_test():
    ...
    test_story = f"Hey {user_name}! I had the most amazing pizza during TidalHACKS25! It was a pepperoni masterpiece that fueled my coding marathon. The cheese was perfectly melted and the crust was crispy. It gave me the energy to debug for 8 hours straight and build an incredible AI project!"
