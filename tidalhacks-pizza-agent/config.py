...
# Conference Settings
CONFERENCE_ID = "TIDALHACKS25"  # Change for different events
CONFERENCE_NAME = "TidalHACKS25"
CONFERENCE_START_DATE = "2025-10-24"  # YYYY-MM-DD format
CONFERENCE_END_DATE = "2025-10-26"   # YYYY-MM-DD format

# Agent Settings
AGENT_NAME = "tidalhacks-pizza"
AGENT_SEED = "tidalhacks_pizza_agent_seed_2025"  # Change to reset agent identity
